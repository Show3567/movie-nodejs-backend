...
var dtoCheck = function (DtoClass, callback) {
    ...
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dto = (0, class_transformer_1.plainToInstance)(DtoClass, req.body);
                ...
                case 1:
                    ...
                    if (errors.length > 0) {
                        if (callback) {
                            err = callback(errors);
                            loggerConfig_1.default.error((0, loggerConfig_1.loggerErr)("dtoCheck", 400, "", err));
                            res.status(400).json(err);
                        }
                        else {
                            loggerConfig_1.default.error((0, loggerConfig_1.loggerErr)("dtoCheck", 400, "", errors));
